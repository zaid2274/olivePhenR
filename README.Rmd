...
`olivePhenR` est un package R permettant de modéliser les stades phénologiques de l'olivier et d'analyser les risques de gel tardif à partir de données climatiques journalières.
...
> Les données WorldClim sont téléchargées automatiquement via le package `geodata`.
> Les occurrences de l'olivier (*Olea europaea*) sont importées via le package `rgbif`.
